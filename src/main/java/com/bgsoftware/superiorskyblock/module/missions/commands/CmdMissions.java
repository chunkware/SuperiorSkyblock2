...
public class CmdMissions implements ISuperiorCommand {
	...
	public String getUsage(java.util.Locale locale) {
		return "zadania [" + Message.COMMAND_ARGUMENT_MISSION_CATEGORY.getMessage(locale) + "]";
	}
	...
	public List<String> tabComplete(SuperiorSkyblockPlugin plugin, CommandSender sender, String[] args) {
		if (args.length == 2) {
			...
			return CommandTabCompletes.getMissionCategories(plugin, args[1],
					category -> hasIsland || plugin.getMissions().isPlayerMissionCategory(category));
		}
